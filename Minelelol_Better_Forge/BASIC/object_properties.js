    ...
    function makeMainScreen(screenManager) {
        ...
        function buildModel(data) {
            ...
            model.group('General', model => {
                ...
                if (hasSpawn) {
                    model.add(makeProperty('respawn_rate', 'Respawn Rate', 'range', { min: 0, max: 250, step: 1 }, ' This controls how many seconds it will take for this type of item to respawn on the map.'))
            ...
            if (isTeleporter) {
                model.add(makeProperty('teleporter_channel', 'Channel', 'range', { min: 0, max: 255, step: 1 },))
            }
